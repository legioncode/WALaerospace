...
def getProblem():
    """This function prompts the user for which problem they want to solve and returns this problem"""
...
def getParcellist():
    """This function prompts the user for which parcellist they want to use and returns this list"""
...
def getAlgorithmA():
    """This function prompts the user for which algorithm they want to use and returns this"""
    algorithm = input(
...
def getHillclimber(shiplist, parcellist):
    """This function prompts the user to choose whether they want to use a hillclimber or not and returns the results if so"""
    choice = input(
...
def getConstraint():
    """This function prompts the user for an additional constraint and returns the name of the appropriate algorithm"""
    constraint = input(
